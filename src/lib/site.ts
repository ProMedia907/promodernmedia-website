...
export type Review = {
  name: string;
  /**
   * Secondary line under the name: the customer's business for sample
   * reviews, or when it was posted for reviews pulled from Google.
   */
  meta: string;
  rating: 1 | 2 | 3 | 4 | 5;
  body: string;
  /** Google reviewer profile photo, when the review came from Google. */
  photoUri?: string;
  /** Link to the review on Google Maps. Required attribution for live reviews. */
  href?: string;
};
